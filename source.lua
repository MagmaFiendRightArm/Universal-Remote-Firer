-- Universal Remote Firer By mxkxkks (Updated with anti-crash)
...
-- https://www.roblox.com/games/18939066871/Diddy-Plinko-RNG-V2-X2-WEEKEND [Fast Drop Autofarm]

-- [[]]

local a = {}
local crashCount = 0
local maxCrashAttempts = 5
...
local function e(...)
    ...
    for g, h in ipairs(a) do
        ...
        if h:IsA("RemoteEvent") then
            pcall(function() h:FireServer(unpack(f)) end)
        elseif h:IsA("BindableEvent") then
            pcall(function() h:Fire(unpack(f)) end)
        elseif h:IsA("RemoteFunction") then
            spawn(function()
                pcall(function() return h:InvokeServer(unpack(f)) end)
            end)
        elseif h:IsA("BindableFunction") then
            spawn(function()
                pcall(function() return h:Invoke(unpack(f)) end)
            end)
        end
    end
end
...
e("Talents", 50)
e("AbilityPoints", 75)
e("Stats", {strength=100, agility=80, intelligence=90})
e("Attributes", {health=1000, mana=500, stamina=750})
e("Inventory", {"Sword", "Shield", "Potion"})
e("Equipment", {weapon="Excalibur", armor="Dragon Scale"})
e("Quest", "Complete")
e("Mission", "Accomplished")
e("Achievement", "Unlocked")
e("Rank", "Platinum")
e("Title", "Legendary Hero")
e("Badge", "Earned")
e("Prestige", 5)
e("Fame", 10000)
e("Reputation", 5000)
...
e("Cutscene", "Watch")
e("Dialogue", "Next")
e("Checkpoint", "Reached")
e("Respawn", true)
e("Revive", true)
e("Resurrect", true)
e("Teleport", Vector3.new(0, 100, 0))
e("Warp", "Dungeon")
e("Portal", "Enter")
e("Instance", "Create")
e("Server", "Join")
e("Event", "Participate")
e("Tournament", "Register")
e("Season", "Start")
e("Battle Pass", "Purchase")
e("Loot Box", "Open")
e("Gacha", "Roll")
e("Spin", "Wheel")
e("Roulette", "Play")
e("Lottery", "Buy Ticket")
e("Jackpot", "Win")
e("Bonus", "Claim")
e("Reward", "Collect")
e("Gift", "Send")
e("Mail", "Read")
e("Notification", "Clear")
e("Chat", "Send Message")
e("Emote", "Use")
e("Gesture", "Perform")
e("Dance", "Start")
...
e("Swimming", 45)
e("Diving", 50)
e("Cash", 1000) -- Yes, ik some of these are already listed above. This was implemented incase i missed anything.
e("Coins", 500)
e("Gems", 100)
e("Bucks", 250)
e("Credits", 750)
...
e("BankDeposit", 5000)
e("WithdrawCash", 1000)
e("TransferMoney", {to = "Player2", amount = 500})
e("ConvertCurrency", {from = "Coins", to = "Gems", amount = 1000})
e("PurchaseItem", {item = "VIP", cost = 500})
e("SellItem", {item = "OldSword", price = 100})
e("Refund", 250)
e("TipJar", 50)
e("DonationAmount", 100)
e("FundRaiser", 1000)
e("CharityEvent", 5000)
e("InvestmentReturn", 1500)
e("StockMarketGain", 2000)
e("LotteryTicket", 10)
e("ScratchCard", 5)
e("SlotMachine", {bet = 100, lines = 3})
e("RouletteChips", 500)
e("PokerStakes", 1000)
e("BlackjackBet", 200)
e("DiceRollBet", 50)
...
e("RaffleTicket", 20)
e("AuctionBid", 5000)
e("MarketplaceListing", {item = "RareHat", price = 10000})
e("TradeOffer", {give = "BlueGem", receive = "RedGem"})
e("GiftCard", 1000)
e("ReferralBonus", 250)
e("WelcomeBonus", 100)
e("LoginStreak", 7)
e("HourlyBonus", 50)
e("WeeklyAllowance", 1000)
e("MonthlyStipend", 5000)
e("SeasonalReward", 2500)
e("EventPrize", 1000)
e("TournamentWinnings", 10000)
e("LeaderboardReward", 5000)
e("AchievementBonus", 500)
e("LevelUpReward", 1000)
e("PrestigeBonus", 5000)
e("VIPPerks", {dailyCoins = 1000, exclusiveItems = true})
e("Admin", true) -- Again, testing only.
e("Mod", true)
e("Owner", true)
e("Staff", true)
e("Rank", "Admin")
e("Permissions", {"Kick", "Ban", "Mute"})
e("AdminLevel", 5)
